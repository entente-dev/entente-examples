...
function getLatestVersion(packageName) {
  try {
    ...
    log(`  ⚠️  Could not fetch latest version for ${packageName}, using ^0.1.11`, 'yellow');
    return '^0.1.11';
  }
}
...
function main() {
  ...
  if (totalUpdated > 0) {
    ...
    try {
      ...
      log(`\n✅ Successfully updated ${totalUpdated} package(s) to latest published versions`, 'green');
    } catch (error) {
